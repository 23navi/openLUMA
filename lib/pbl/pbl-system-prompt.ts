...
- All project titles, descriptions, role names, issue titles, issue descriptions, and student-facing text MUST be in ${languageName}
- Keep tool names, field names, and required enum values exactly as specified in English
...
function getPromptLanguageName(language: string): string {
  switch (language) {
    case 'hi-IN':
      return 'Hindi';
    case 'gu-IN':
