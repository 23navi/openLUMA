...
import type { ClassroomLanguage } from '@/lib/classroom-languages';
...
export interface UserRequirements {
  ...
  language: ClassroomLanguage; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: ClassroomLanguage; // Generation language (inherited from requirements)
