...
import { getClassroomLanguagePromptName } from '@/lib/classroom-languages';
...
- Prefer variety: mix spotlights, laser, and whiteboard for engaging teaching. Don't use the same action type repeatedly.`
  ...
  const languageConstraint = courseLanguage
    ? `\n# Language (CRITICAL)\nYou MUST speak in ${getClassroomLanguagePromptName(courseLanguage)}. ALL text content in your response MUST be in this language.\n`
    : '';
